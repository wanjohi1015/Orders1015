package com.blueprint211.delreq.Adapter;
...
import com.blueprint211.delreq.R;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartHolder> {
    ...
    String userid;
    String documentid,ddocumenttid;
        ...
        public CartHolder(@NonNull View itemView) {
            ...
            deleteItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String title = cartList.get(getAbsoluteAdapterPosition()).getTitle();
                    userid = Objects.requireNonNull(firebaseAuth.getCurrentUser()).getUid();
                        ...
                        documentid = cartList.get(getAbsoluteAdapterPosition()).getProductid();


                        // makes the values zero // if deleted
                        firestore.collection("P" +
                                "roducts").document(documentid).update("quantity",
